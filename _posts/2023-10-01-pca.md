...
Burada sütun toplamları **özdeğerleri**, satır toplamları **temel bileşenleri** ve değişkenleri açıklama oranını verir.  hj^2 (Extraction)  2^h<sub>j</sub> büyük olması gerekir.
