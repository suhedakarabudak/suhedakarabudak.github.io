...
<span>$$\(\sum_{i=1}^{m} \frac{\lambda_i}{p} \geq \frac{2}{3}\)<span>$$ 2/3 yaklaşık 0.67 geliyor.Bu koşulu sağlayan en büyük m saysısı bize temel bileşen sayısını verir.Önemli temel bileşene kara vermemiz için 1'den büyük özdeğerleri toplayarak bulabiliriz.
