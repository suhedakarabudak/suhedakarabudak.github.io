...
\end{bmatrix}
$$ 
Burada sütun toplamları **özdeğerleri**, satır toplamları **temel bileşenleri** ve değişkenleri açıklama oranını verir. 2^h<sub>j</sub> (Extraction) h<sub>j</sub> büyük olması gerekir.
1- h<sub>j^2</sub> açıklanamayan oranı verir.
