...
2. %68-95-99.7 kuralı, istatistiksel olarak normal dağılıma sahip bir veri setinin belirli aralıklarda yoğunlaşma eğilimini ifade eden bir kuraldır.
          ...
          -%95 kısmı, normal dağılımın ortalama etrafında iki standart sapma mesafesindeki veri noktalarını içerir. Bu, dağılımın genişliği ve yayılma özelliği hakkında bilgi verir. Bu bölge, %68 bölgesine ek olarak daha geniş bir aralığı kapsar.

          -%99.7 kısmı, normal dağılımın ortalama etrafında üç standart sapma mesafesindeki veri noktalarını içerir. Bu, dağılımın genişliği ve kapsamı hakkında daha fazla bilgi verir. Bu bölge, dağılımın genişliğinin ve veri noktalarının yayılmasının daha geniş bir göstergesidir.
